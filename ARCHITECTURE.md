...
| 2026-08-23 | Aligned the approved-story handoff with Step 4's actual first action: start the picture plan, while hiding obsolete story approval controls.                                                                                               | `src/app/projects/[projectId]/story/`, `src/lib/projects/project-progress.ts`, `e2e/home.spec.ts`           |
