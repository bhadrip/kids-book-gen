...
| SKP-08 | Package performance, Visual Bible, proof, illustration, production-review, and revision-brief skills after they land on `main`. | **in progress** | Corresponding skills merged; SKP-05 | Every transitive resource is bundled and every output contract validates.                                                      |
...
### SKP-08 illustration pilot

The first bounded SKP-08 slice is the
[Turnip style-preserved hybrid illustration pilot](turnip-style-preserved-hybrid-pilot.md).
It schedules only interaction-aware SVG assembly, contrast reduction, and a
bounded emotion scale while preserving the approved characters and art language.
SKP-08 remains in progress until the remaining named skills, synchronization
check, and complete transitive-resource validation are delivered.
